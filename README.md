...
## Overview
This project analyzes FitBit smart device usage data to identify behavioral trends in activity, sleep, and sedentary behavior. The insights are used to inform Bellabeat's marketing strategy for the Leaf wellness tracker.
...
- 35 FitBit users, April-May 2016
- Tables analyzed: Daily Activity, Hourly Steps, Sleep, Weight Log

## Key Findings
1. Users average only 6,547 steps/day — below the recommended 10,000
2. Users are sedentary for over 16 hours per day
3. Peak activity hours are 12PM and 6-7PM
...
## Author
Daniel Eniola | [GitHub](https://github.com/daniel-eniola)
